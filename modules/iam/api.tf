...
# GCP send e-mail with this messages Cloud DNS API will become a required dependency for upcoming capabilities in GKE.
resource "google_project_service" "enable-api-cloud-dns" {
